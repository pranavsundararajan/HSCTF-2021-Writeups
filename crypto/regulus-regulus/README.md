...
### Intended Solution
I'm not sure that this specific solution will always work, although I had no issues with it even after testing it on multiple cases. The intended solution was to use `d + φ(n)/2`. This is based off [this reddit post] (https://www.reddit.com/r/crypto/comments/7xb1gl/someone_found_that_there_is_a_second_private_key/) which is interesting, as they used Euler's totient instead of Carmichael. Apparently, in many of these cases, the Carmichael value divided by Euler's comes out to 0.5, allowing us to use it on it's own without any manipulation. I'm still not sure how this worked out, but it's quite an interesting situation, and anyways a flag is a flag. 
